...
dat = readLines("shape_of_you.txt") # read data from txt file.
...
```{r}
df_urls <- read.csv(file="./songs_url_list_Ed_Sheeran.csv", header=TRUE, sep=",")
df_urls
```

```{r}
df_songs <- read.csv(file="./songs_lyrics_list_Ed_Sheeran.csv", header=TRUE, sep=",")
df_songs
```
